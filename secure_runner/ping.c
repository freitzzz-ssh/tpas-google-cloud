...

{
    ...
    if (inaddr = inet_addr("34.76.250.37") == INADDR_NONE)

    {

        if ((host = gethostbyname("34.76.250.37")) == NULL)
...
Æ        }
        ...
        dest_addr.sin_addr.s_addr = inet_addr("34.76.250.37");


    pid = getpid();

    printf("PING %s(%s): %d bytes data in ICMP packets.\n", "34.76.250.37", inet_ntoa
